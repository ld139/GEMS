...
def get_sequence_loss_batch(model, alphabet, coords_list, seq_list):
    ...
    print("debug: coords, padding_mask, confidence, prev_output_tokens shapes: ", coords.shape, padding_mask.shape, confidence.shape, prev_output_tokens.shape)
...
def main():
    ...
    parser.add_argument('--DMS_id',type=str,help='id of DMS in DMS reference file')
    ...
    # print(DMS_id, DMS_filename)
    # print(args.output_scores_folder)
    ...
    pdb_file = args.structure_folder + os.sep + DMS_id + ".pdb"
    # print(pdb_file)
    # print(pdb_file)
...
if __name__ == '__main__':
    main()
    # model_location = "/export/home/luod111/.cache/torch/hub/checkpoints/esm2_t33_650M_UR50D.pt"
    # pdb_file = "/export/home/luod111/PLMs/motimodal/ESM_IF1/UPO/DATASET/mcaupo/mcaupo.pdb"
    # mutation_file = "/export/home/luod111/PLMs/motimodal/ESM_IF1/UPO/DATASET/mcaupo/mcaupo.csv"
    # output_filepath = "/export/home/luod111/PLMs/motimodal/ESM_IF1/UPO/DATASET/mcaupo/mcaupo_esmif1.csv"
    # model, alphabet = esm.pretrained.load_model_and_alphabet(model_location)
    # print(alphabet)
    # model = model.eval()
    # score_singlechain_backbone_batch(model, alphabet, pdb_file=pdb_file, batch_size=1, chain='A', mutation_file=mutation_file, output_filepath=output_filepath, nogpu=False)
