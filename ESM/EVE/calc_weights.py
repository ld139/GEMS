...
def create_argparser():
    ...
    parser.add_argument('--DMS_id', type=str, help='id of protein in input mapping file', required=True)
...
def main(args):
    ...
    if args.MSA_filepath is not None:
        ...
        # print(mapping_file)
        protein_name = args.DMS_id
        msa_location = args.MSA_data_folder + os.sep + protein_name + ".a2m"
